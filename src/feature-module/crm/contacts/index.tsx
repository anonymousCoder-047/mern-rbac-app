...
const ContactDetails = () => {
  ...
  const handleSendEmail = async () => {
    try {
      ...
      if(response) navigate(route.contactList);
    } catch(err) {
  ...
  const handleDelete = async () => {
    try {
      const { Contact } = endpoints
      const response = await PrivateServer.deleteData(Contact.delete, contactDetails?.contactId);
                ...
                <div className="row align-items-center">
                  <div className="col-sm-4">
                    <h4 className="page-title">
                      Contacts<span className="count-title">{contactDetails?.totalData}</span>
                    </h4>
                  </div>
                ...
                <div className="row align-items-center">
                  <div className="col-sm-6">
                    <ul className="contact-breadcrumb">
                      ...
                      <li>{`${contactDetails?.first_name} ${contactDetails?.last_name}`}</li>
                    </ul>
                  </div>
                  {/* <div className="col-sm-6 text-sm-end">
                    <div className="contact-pagination">
                      <p>1 of {contactDetails?.totalData}</p>
                      <ul>
                        <li>
                ...
                <div className="card-body p-3">
                  ...
                  <div className="mb-3">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <p>{contactDetails?.secondary_phone}</p>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar avatar-xs bg-light-300 p-0 flex-shrink-0 rounded-circle text-dark me-2">
                  ...
                  <ul>
                    <li className="row mb-3">
                      ...
                      <span className="col-6">{contactDetails?.code}</span>
                    </li>
                    <li className="row mb-3">
                      <span className="col-6">State</span>
                      <span className="col-6">{contactDetails?.state}</span>
                    </li>
                    <li className="row mb-3">
                      <span className="col-6">City</span>
                      <span className="col-6">{contactDetails?.city}</span>
                    </li>
                    <li className="row mb-3">
                      <span className="col-6">Country</span>
                      <span className="col-6">{contactDetails?.country}</span>
                    </li>
                    <li className="row mb-3">
                      <span className="col-6">Comments</span>
                      <span className="col-6">{contactDetails?.description}</span>
                    </li>
                  </ul>
                  <hr />
                  <div className="d-flex align-items-center justify-content-between flex-wrap">
        ...
        <div className="modal-body">
          <div className="text-center">
            ...
            <div className="d-flex align-items-center justify-content-center mt-4">
              ...
              <Link to={route.contactList} onClick={handleDelete} className="btn btn-danger">
                Yes, Delete it
              </Link>
            </div>
          </div>
              ...
              <div className="success-message text-center">
                ...
                <div className="col-lg-12 text-center modal-btn">
                  ...
                  <Link
                    ...
                    state={{ ...contactDetails, totalData: contactDetails?.totalData }}
                    data-bs-dismiss="modal"
                    className="btn btn-primary"
                  >
                    View Details
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="success-message text-center">
                ...
                <div className="col-lg-12 text-center modal-btn">
                  <Link to={route.contactDetails} state={{ ...contactDetails, totalData: contactDetails?.totalData }} className="btn btn-primary">
                    Go to email
                  </Link>
                </div>
              </div>
