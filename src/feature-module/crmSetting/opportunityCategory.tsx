...
const OpportunityCategory = () => {
  ...
  const [OpportunityCategoryId, setOpportunityCategoryId] = useState("");
  ...
  const handleEditOpportunity = (values) => {
    setFormData({ ...formData, ..._.omit(values, ["_id"]), opportunityCategoryId: values?._id });
  }
  ...
  const columns = [
    {
      ...
      dataIndex: "opportunity_type_name",
       sorter: (a: any, b: any) =>
        a.opportunity_type_name.length - b.opportunity_type_name.length,
      key: "opportunity_type_name",
      width: "237px",
    },
    {
      title: "Created By",
        ...
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            {values?.permissions?.includes('delete') && (<Link
              ...
              onClick={() => setOpportunityCategoryId(record?._id)}
            >
  ...
  const handleBulkDelete = async () => {
    const { OpportunityCategory } = endpoints;
    const deleted = await PrivateServer.deleteBulkData(OpportunityCategory?.delete_bulk, selectedIds)
    if(deleted) {
      setShowBulkActionButton(false);
          ...
          <div className="col-md-12">
              ...
              <div className="row align-items-center">
                <div className="col-8">
                  <h4 className="page-title">
                    Opportunity Category<span className="count-title">{searchTerm != "" ? searchData?.length : OpportunityCategoryData?.length}</span>
                  </h4>
                </div>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <Table columns={columns} dataSource={searchTerm != "" ? searchData : OpportunityCategoryData} handleBulkAction={handleBulkOperation} />
                </div>
                <div className="row align-items-center">
          ...
          <form >
            <div className="modal-body">
              <div className="mb-3">
                ...
                <input type="text" name="opportunity_type_name" value={formData?.opportunity_type_name} onChange={handleChange} className="form-control" />
              </div>
            </div>
